...
{
	PM->APBCMASK.reg |= (PM_APBCMASK_SERCOM3 | PM_APBCMASK_SERCOM1); 
	...
	GCLK->CLKCTRL.reg = GCLK_CLKCTRL_CLKEN | GCLK_CLKCTRL_GEN_GCLK0 | GCLK_CLKCTRL_ID_SERCOM3_CORE; // for uart
	GCLK->CLKCTRL.reg = GCLK_CLKCTRL_CLKEN | GCLK_CLKCTRL_GEN_GCLK2 | GCLK_CLKCTRL_ID_SERCOM1_CORE; // for i2c
} 
